...
local document_template_tab = {
    parse({ trig = "latexartcl", name = "template for latex article" },
        [[
% Preamble
% Document Class
\documentclass[11pt, oneside, headsepline=on, parskip=half, numbers=enddot, intlimits]{scrartcl} % Explanation see below.
